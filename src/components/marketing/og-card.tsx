...
export async function renderOgCard(locale: string) {
    ...
    const brand = await getTranslations({ locale, namespace: "common" });
            ...
            >
                ...
                >
                    <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                        ...
                        <div style={{ display: "flex", fontSize: 32, fontWeight: 700, color: FOREGROUND }}>
                            {brand("brandName")}
                        </div>
                    </div>
                    ...
                    >
                        <div style={{ display: "flex", color: PRIMARY }}>{siteHost}</div>
